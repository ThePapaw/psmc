...
def skinswap():
    ...
    if skin not in ['skin.confluence','skin.estuary']:
        choice = xbmcgui.Dialog().yesno(AddonTitle, 'Please Wait while we try to reset to the default PSMC Skin...', yeslabel='Yes',nolabel='No')
        if choice == 0:
            sys.exit(1)
