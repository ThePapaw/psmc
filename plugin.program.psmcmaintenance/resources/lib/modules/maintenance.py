...
addonPath = os.path.join(os.path.join(translatePath('special://home'), 'addons'),'plugin.program.psmcmaintenance')
...
iconpath = translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.gif'))
class cacheEntry:
