...
class navigator:
    ...
    def tools(self):
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'fuzzybritchesscrapersettings', 'iconF.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : Cache Functions', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : Log Functions', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : View Log', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : Upload Log to hastebin', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Fuzzy Britches v3[/B] : Empty Log', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
