...
3. After the repo is installed, install the addon(s) of your choosing. You can also install the [B][COLOR firebrick]Fuzzy Britches[/COLOR][/B] repo from this repo for more "media" type addons.
