...
def main():
	...
	kodi.add_menu_item({'mode': 'search_menu', 'type': "repository", 'title': "Search by GitHub Repository Title"}, {'title': "Search by GitHub Repository Title [COLOR red](Experimental)[/COLOR]"}, icon='repository.png')
	kodi.add_menu_item({'mode': 'search_menu', 'type': "addonid",'title': "Search by Addon ID"}, {'title': "Search by Addon ID [COLOR red](Experimental)[/COLOR]"}, icon='addonid.png')
...
def about():
	...
	kodi.dialog_textbox('PSMCs GitHub Browser Instructions', text)
